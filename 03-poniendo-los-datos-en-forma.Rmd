...
:::warning
Si recibimos un mensaje de error al estilo de `[...] Error in left_join(atencion_ciudadano, barrios_comunas) : 
  could not find function "left_join` es muy probable que nos hayamos olvidado de activar las funciones de Tidyverse. En ese caso, sólo necesitamos ejecutar `library(tidyverse)` e intentar de nuevo.
:::
