...
Antes de continuar, vamos a instalar dos paquetes nuevos de funciones: `pdftools`, que permite extraer el texto de archivos en formato PDF, y `flextable`, que nos permite crear de forma fácil bellas tablas y resúmenes de información. 
Para instalarlos usamos `install.packages()`, tal como hicimos antes para instalar otros paquetes.
